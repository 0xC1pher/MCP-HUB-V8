...
# Aliases para compatibilidad con v5 (nombres esperados por mcp_server_v5)
try:
    # Sistema de chunking adaptativo
    from .dynamic_chunking import DynamicChunkingSystem as DynamicChunker

    # Sistema principal de expansión automática de queries
    from .query_expansion import AutoQueryExpander as QueryExpander

    # Sistema principal de calibración dinámica de confianza
    from .confidence_calibration import DynamicConfidenceCalibrator as ConfidenceCalibrator
except ImportError as e:
    logger = logging.getLogger(__name__)
    logger.warning(f"Could not import advanced features classes for v5 compatibility: {e}")
    DynamicChunker = None
    QueryExpander = None
